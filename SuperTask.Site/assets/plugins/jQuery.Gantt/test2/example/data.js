var ganttData = [
	{
		id: 1, name: "任务 1", series: [
			{ name: "任务 1", start: new Date(2010, 00, 01), end: new Date(2010, 00, 03) },
			{ name: "子任务1-2", start: new Date(2010, 00, 02), end: new Date(2010, 00, 05), color: "#f0f0f0" },
			{ name: "子任务1-2", start: new Date(2010, 00, 02), end: new Date(2010, 00, 05), color: "#f0f0f0" }
		]
	}, 
	{
