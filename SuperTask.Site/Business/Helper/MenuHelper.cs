   ...
   public class MenuHelper
   {
      ...
      public static List<MenuItem> GetProjectMenuItems(Guid projectId,Guid userId,Guid checkedId)
      {
         ...
         var subMenu= new List<MenuItem>()
         {
            ...
            new MenuItem { Id = ProjectFilePageCode,FullTitle = "项目文件夹", Title = "项目文件夹", IsVisible =  ResourceHelper.HasPermission(userId, projectId, "P_10006", new APDBDef()), Url = string.Format("/ShareFolder/{0}?projectId={1}", "Index", projectId)},
            ...
            new MenuItem { Id = ProjectTaskPageCode, FullTitle = "任务管理",Title = "任务管理", IsVisible = true, Url = string.Format("/TaskV2/{0}?projectId={1}", "List", projectId)},
