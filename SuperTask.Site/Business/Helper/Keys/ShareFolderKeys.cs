...
namespace Business.Helper
{
   ...
   public static class ShareFolderKeys
   {
      ...
      //TODO
      public static Guid ProjectType = Guid.Parse("");

      public static Guid RequiredType = Guid.Parse("");
      public static Guid DevelopType = Guid.Parse("");
      public static Guid TestType = Guid.Parse("");
      public static Guid PublishType = Guid.Parse("");
