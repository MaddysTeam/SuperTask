...
namespace Business.Helper
{
	...
	public static class BugKeys
	{
		...
		/// bug确认
		/// </summary>
		public static Guid BugConfirmGuid = Guid.Parse("074a8898-b8d4-4482-b6be-0347513e9a23");
		...
		/// bug解决
		/// </summary>
		public static Guid BugResolveGuid = Guid.Parse("30feb559-70a8-4c02-bc61-d319b349bd94");
		...
		public static string GetResultByValue(Guid val) => DictionaryHelper.GetDicById(BugConfirmGuid, val).Title;

		public static string GetResolveByValue(Guid val) => DictionaryHelper.GetDicById(BugResolveGuid, val).Title;
