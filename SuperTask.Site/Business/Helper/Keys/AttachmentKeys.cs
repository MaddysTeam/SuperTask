...
namespace Business.Helper
{
	...
	public static class AttahmentKeys
	{
		...
		public static string EmptyFolderIcoPath=> GetVirtualPath("folder.gif");
		...
		public static Dictionary<string, string> FileIcos => new Dictionary<string, string>
		 {
		   ...
		   {".xls",GetVirtualPath("xlsx_win.png")},
		   ...
		   {".vsd",GetVirtualPath("vsd.png")},
		   {".vsdx",GetVirtualPath("vsd.png")},
		   ...
		   {".tmp",GetVirtualPath("settings.png")},
		};
