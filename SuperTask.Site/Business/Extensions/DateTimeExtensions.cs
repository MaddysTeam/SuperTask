...
namespace Business
{
   ...
   public static class DateTimeExtensions
   {
      ...
      public static string ToyyMMdd(this DateTime date)
      {
         return date.IsEmpty() ? " " : date.ToString("yyyy-MM-dd");
      }

      public static string ToyyMMddWithoutLine(this DateTime date)
      {
         return date.IsEmpty() ? " " : date.ToString("yyyyMMdd");
      }

      public static String ToyyMMddHHmmss(this DateTime date)
      {
         return date.IsEmpty() ? " " : date.ToString("yyyy-MM-dd HH:mm:ss");
      }
